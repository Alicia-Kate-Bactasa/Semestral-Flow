                      ...
                      <div className="space-y-2">
                        {term.courses.map((c) => {
                          ...
                          return (
                            <div
                              key={c.code}
                              className="p-3 bg-white dark:bg-slate-800 border border-slate-200/60 dark:border-slate-700 rounded-xl flex items-center justify-between text-xs sm:text-sm"
                            >
                              <div>
