        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
            <div>
              ...
              <span className="ml-2.5 px-2 py-0.5 text-[10px] font-semibold text-slate-600 bg-slate-100 rounded border border-slate-200/60">
                {user?.program || 'BS IT'}
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              onClick={onLogout}
              className="flex items-center space-x-1.5 px-3 py-1.5 text-xs font-medium text-slate-600 hover:text-rose-600 hover:bg-rose-50 rounded-lg transition-colors border border-slate-200/60"
            >
